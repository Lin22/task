...
// Если вводить несколько чисел через пробел - не получается - надо добавить какую-то функцию после if (numbers[i] % 2 == 0) ;
       /*System.out.print("Сколько целых чисел вы собираетесь ввести? ");
        ...
        // Как ввести с консоли n-размерность матрицы a [n] [n]и затем задать значения элементов матрицы в интервале значений от n до n с помощью датчика случайных
        // чисел- не знаю). Могу только заполнить матрицу случайными числами
        int m2[][]=new int[5][5];
